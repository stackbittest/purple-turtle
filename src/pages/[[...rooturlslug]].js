...
export default function RootUrlPage(props) {
  ...
  return (
    <div data-sb-object-id={ props.originalfilepath }>{ props.originalfilepath }
    <LayoutHello>
...
export async function getStaticProps(context) {
  ...
  return {
    props: {
      originalfilepath: extraparams.params.originalfilepath.replace('/home/appuser/app/src/content',''),
